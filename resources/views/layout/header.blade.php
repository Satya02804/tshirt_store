...
<nav class="navbar navbar-light bg-light px-3">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ asset('/tshirt') }}"><strong> T-Shirt Store
                <svg height="30px" width="30px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-38.24 -38.24 458.86 458.86" xml:space="preserve"
                    fill="#000000" stroke="#000000" stroke-width="0.00382375" transform="rotate(45)">
